    ...
    * */
    ...
    // 需要使用这个表达式的地方使用方法名引入 @After("hahaMyPoint()")
     ...
     public static void logStarta(JoinPoint joinPoint){
         ...
         System.out.println("[logUtils-前置]["+methodName+"]方法开始执行，用的参数列表["+Arrays.asList(args)+"]");
     }
     ...
     public static void logReturn(JoinPoint joinPoint, Object result){
         ...
         System.out.println("[logUtils-返回]方法"+signature+"执行完成，计算结果是"+result);
     }
     ...
     public static void logException(JoinPoint joinPoint, Exception exception){
         ...
         Signature signature = joinPoint.getSignature();
         String methodName = signature.getName();
         System.out.println("[logUtils-异常]"+methodName+"方法执行异常,参数列表是"+ Arrays.asList(args)+"错误信息是"+exception);
     }
     ...
     public static void logEnd(JoinPoint joinPoint){
         ...
         Signature signature = joinPoint.getSignature();
         String name = signature.getName();
         System.out.println("[logUtils-结束]方法"+name+"执行了，最终结束了，参数是"+Arrays.asList(args));
     }
